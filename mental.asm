...
playRow
	di
;	ld ix,$2121		;VZ 		- enable both tone channels (it is mask to xor with output) +
	ld ix,$4040		;MICROBEE 	- enable both tone channels (it is mask to xor with output) +
;	ld ix,$1010		;ZX		- enable both tone channels (it is mask to xor with output) +
...
noMute1
	...
	xor	a
	ld 	h,32
	ld 	de, $4040	; $2121 ;$0101 ; $2121	;3333
	exx
	ld 	b,a
drumPtr EQU $+1
	ld 	hl,0
