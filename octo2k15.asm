...
;******************************************************************
;
;	Ported to Microbee by Bushy555.
;	Assemble with PASMO:		
;				PASMO --alocal oct2k15.asm oct2k15.com
;	Origin set to $100 for microbee CP/M .COM file 
;
;
