...
; ******************************************************************************
;
; This actual code below assembles and runs on real Hardware. Tested & verified by DM.
;
;
; Assemble with:       
;
; ZX   		pasmo --alocal filename.asm filename.bin		ORG	40000
;		bin2tap filename.bin filename.tap
;
; VZ   		pasmo --alocal filename.asm filename.obj		ORG	$8000
;	 	rbinary filename.obj filename.vz        
;
; MICROBEE 	pasmo --alocal filename.asm filename.obj		ORG	$900
;
...
;                OR    BORDER_CLR          ; Remove this line to save 2 bytes if you are happy with a black border :)
		...
		and	64			; MICROBEE.  	Mask bit 6
                OUT   (2),A			; MICROBEE.	Output music data.
