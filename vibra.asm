...
ret4
	...
	ld a,iyh		;8		;load output state ch2
	out ($2),a		;11__80		;output state ch2
	exx			;4
	ld a,(noiseVolume)	;13		;load output state noise
	cp h			;4
	sbc a,a			;4
	ds 7			;28
	out ($2),a		;11__64		;output noise state
	jp soundLoop		;10
...
vibrSpeed2 equ $+1
	...
	out ($2),a		;11___80	;output state ch1
...
retv2
	...
	exx			;4
	ld a,iyh		;8		;load output state ch2
	out ($2),a		;11___80	;output ch2
		
	ds 2			;8
	ld a,r			;9		;timing
	exx			;4
	ld c,$2		;7		;restore C'=$2 (needed by main sound loop)
	exx			;4
	
	ld a,(noiseVolume)	;13		;load output state noise
	cp h			;4
	sbc a,a			;4
	out ($2),a		;11___64	;output noise state
...
task_read_ch1				;update ch1 data
	...
	ld sp,(ptnPointer)	;20
	pop de			;11	;2tch note divider ch1
	ld a,ixh		;8
	out ($2),a		;11___81
...
task_read_ch2				;update ch2 data
	...
	ld sp,(ptnPointer)	;20
	exx			;4
	pop de			;11	;2tch note divider ch2
	ld a,ixh		;8
			;11___85
...
doSlideDownCh2	
	...
	ld (fxType2),a		;13
			...
			;11___67 fake noise (A = $c3, so will always output 0)
	jp soundLoop		;10	
